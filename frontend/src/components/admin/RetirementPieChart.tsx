    ...
    <div className="admin-chart-card">
      <div className="admin-chart-header">
        ...
        <p className="admin-chart-subtitle">
          Distribución por motivos de salida (Total de retiros: {total})
        </p>
      </div>
      <div className="admin-chart-content">
        <ResponsiveContainer width="100%" height={350}>
          <PieChart>
            ...
            <Pie data={data} dataKey="value" nameKey="name" cx="50%" cy="50%" innerRadius={100} outerRadius={120} fill="#82ca9d" label />
            <Tooltip />
            <Legend />
          </PieChart>
        </ResponsiveContainer>
        <div className="admin-chart-note">
          <p>* El gráfico exterior representa los motivos principales de retiro, mientras que el interior muestra su desglose más detallado.</p>
        </div>
      </div>
    </div>
  );
